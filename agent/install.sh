...
for file in __init__.py main.py client.py system_info.py jobs.py job_lease.py runtime_spec.py runtime_download.py runtime_engine.py runtime_client.py singbox-release.json proxyforge-agent.service; do
...
for file in __init__.py main.py client.py system_info.py jobs.py job_lease.py runtime_spec.py runtime_download.py runtime_engine.py runtime_client.py singbox-release.json; do
