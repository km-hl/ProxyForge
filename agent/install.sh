...
for file in __init__.py main.py client.py system_info.py jobs.py proxyforge-agent.service; do
...
for file in __init__.py main.py client.py system_info.py jobs.py; do
